...
//No longer builds as of recent version of the logging lib.
#ifdef __linux__
...
//No longer working as of recent version of logging lib
#ifdef __linux__
...
int main(int argc, char** argv)
{
	...
	bool 
		isDebugMode = true,
		isVerboseMode = false,
		isWritingToWindow = true;  // Show windows and draw things, unecessary if for the RoboRIO alone.
	int 
		secondsCalculated = 0,
		videoCaptureWidth = 0,
